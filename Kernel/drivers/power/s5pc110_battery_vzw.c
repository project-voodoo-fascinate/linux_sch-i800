...
static int manual_temp_adc = 32000;	
#endif
...
#ifdef __MANUAL_TEMP_TEST__
	fuelgauge_temp = manual_temp_adc;	
#endif
...
static struct device_attribute s3c_battery_attrs[] = {
	...
	SEC_BATTERY_ATTR(chargingblock_clear),
...
static void s3c_cable_check_status(void)
{
	...
	s3c_get_bat_temp(&s3c_power_supplies[CHARGER_BATTERY]); 
